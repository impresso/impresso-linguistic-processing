...
build.d/test_eyeball.txt: 
	python lib/sample_eyeball_output.py 4 $(BUILD_DIR)/$(OUT_S3_BUCKET_LINGPROC)/$(OUT_PROCESS_LABEL_LINGPROC)$(OUT_PROCESS_SUBTYPE_LABEL_LINGPROC)/$(OUT_RUN_ID_LINGPROC)/*/*.jsonl.bz2 > $@
